...
class PluginGCompNetwork(LightningModule):
    """
    Pytorch Lightning Module for the Regression adjusted G-computation CAPO learner with LSTM backbone.
    ...
    Implementation partly based on G-transformer https://github.com/konstantinhess/G_transformer
    """
